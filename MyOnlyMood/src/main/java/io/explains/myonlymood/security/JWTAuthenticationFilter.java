package io.explains.myonlymood.security;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            if (request.getInputStream() != null && request.getInputStream().available() > 0) {
                ...
                user = (UserAccount) authService.loadUserByUsername(credentials.getUsername());
            }
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        UserAccount user = (UserAccount) authService.loadUserByUsername(authResult.getName());
